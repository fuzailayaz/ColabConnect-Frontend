...
const Footer = () => {
  const { theme } = useTheme(); // Assuming you are using next-themes for toggling
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {footerSections.map((section) => (
            <div key={section.title} className="col-span-1">
              <h3 className={`text-sm font-semibold ${theme === 'dark' ? 'text-gray-100' : 'text-gray-900'} tracking-wider uppercase mb-4`}>
                {section.title}
              </h3>
